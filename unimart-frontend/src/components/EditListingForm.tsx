...
export default function EditListingForm({ listing, onBack, onSubmit, isLoading = false }: EditListingFormProps) {
  ...
  const handleInputChange = (field: keyof EditListingFormData, value: string | number) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-tan-50 via-brown-50 to-tan-100 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-brown-800">Edit Listing</h1>
        </div>

        <Card className="card-3d bg-gradient-to-br from-tan-50 to-brown-50 border-brown-200/50">
          <CardHeader>
            <CardTitle className="text-brown-800">Update Listing Details</CardTitle>
          </CardHeader>
          <CardContent>
